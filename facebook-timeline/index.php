							...
							<div class="card shadow-sm">
								<div class="card-body">
									<div class="post-header clearfix">
										<img src="<?php $pst['photo']; ?>" alt="">
										<div class="post-user-info">
											<h4><a href="#"><?php echo $pst['name3']; ?></a></h4>
											<p><?php echo $pst['time']; ?><i class="fas fa-globe-americas"></i></p>
										</div>
										<a class="float-right" href="#"><i class="fas fa-ellipsis-h"></i></a>
									</div>
									<div class="post-content mt-2">
										<p><?php echo $pst['desc3']; ?></p>
										<img src="<?php $pst['image3']; ?>" alt="">
									</div>
									<hr>
